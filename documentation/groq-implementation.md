Groq
Welcome to Groq! 🚀 At Groq, we've developed the world's first Language Processing UnitTM, or LPU. The Groq LPU has a deterministic, single core streaming architecture that sets the standard for GenAI inference speed with predictable and repeatable performance for any given workload.
